...
void run_tests() {
    ...
    std::string encrypted_empty = xor_encrypt(empty_text, key);
    std::string decrypted_empty = xor_decrypt(encrypted_empty, key);
    ...
    std::string encrypted_simple = xor_encrypt(simple_text, simple_key);
    std::string decrypted_simple = xor_decrypt(encrypted_simple, simple_key);

...
private:
    ...
    mutable std::shared_mutex mutex_; // Mutable so we can use it in const methods
};

// Function prototypes...
// (The rest of the code remains unchanged, including price extraction logic and other functions)

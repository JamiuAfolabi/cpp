...
double benchmarkShuffle(Func shuffleFunc, int* arr, size_t n) {
...
int main() {
    ...
    double unoptimizedTime = benchmarkShuffle(fisherYatesShuffleUnoptimized, unoptimizedArray, unoptimizedArray.size());

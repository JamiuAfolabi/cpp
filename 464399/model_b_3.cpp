...
// Custom Loan Types using Type Aliases (for better readability)
using FixedRateLoanMonthly = Loan<struct FixedRateLoanMonthlyType {
...
using FixedRateLoanQuarterly = Loan<struct FixedRateLoanQuarterlyType {
    static constexpr int paymentFrequency = 4;   // Quarterly payments
    static constexpr int loanTermYears = 25;
}>;

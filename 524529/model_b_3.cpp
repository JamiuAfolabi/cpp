...
public:
    ...
    void DeserializeFromJson(const json& data) override {
        try {
            ...
            throw std::runtime_error("Error deserializing Stock: " + e.what());
        }
    }
};
...
public:
    ...
    void DeserializeFromJson(const json& data) override {
        try {
            ...
            throw std::runtime_error("Error deserializing Option: " + e.what());
        }
    }
};
...
public:
    ...
    void DeserializeFromJson(const json& data) override {
        try {
            ...
            throw std::runtime_error("Error deserializing Future: " + e.what());
        }
    }
};
...
int main() {
    ...
    try {
        ...
        newOption.DeserializeFromJson(malformedJson);

...
int main() {
    ...
    try {
        std::u16string utf16_string = encoding::utf8_to_utf16(utf8_string);
        std::cout << "UTF-16: " << utf16_string << std::endl;

        std::string converted_utf8_string = encoding::utf16_to_utf8(utf16_string);
        std::cout << "Converted UTF-8: " << converted_utf8_string << std::endl;

    } catch (const encoding::EncodingError& e) {
